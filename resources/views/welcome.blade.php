...
<html lang="en">
    ...
    <body class="bg-linear-to-br from-gray-800 via-gray-900 to-black h-max">
        ...
        >
            ...
            >
                ...
                >
                    <div class="flex flex-col items-center space-y-2">
                        <i
                            class="bi bi-thermometer-half text-4xl text-red-400"
                        ></i>

                        <h2
                            class="text-base font-semibold tracking-wide text-gray-300"
                        >
                            Temperature
                        </h2>
            ...
            >
                ...
                >
                    <div class="flex flex-row items-center space-x-2">
                        <i
                            class="bi bi-thermometer-half text-2xl text-red-400"
                        ></i>
                        ...
                        <div class="flex flex-col gap-4">
                            <div class="relative flex-1">
                                ...
                                >
                                    ...
                                    <option value="min_temperature">
                                        Min Temperature
                                    </option>
                                    <option value="min_humidity">
                                        Min Humidity
                                    </option>
                                </select>
                            </div>
            ...
            <!-- Chart Section -->
            <section
                class="max-w-6xl mx-auto w-11/12 h-auto md:w-full md:h-auto bg-white/10 backdrop-blur-2xl border border-white/10 rounded-2xl shadow-[0_8px_25px_rgba(255,255,255,0.05)] hover:shadow-[0_10px_25px_rgba(249,248,246,0.5)] p-6 mt-4 mb-6 hover:scale-[1.02] transition-all duration-300"
            >
                <h2
            ...
            >
                ...
                <div
                    class="flex flex-col md:flex-row items-center justify-between mx-4"
                >
                    <div
        ...
        <script>
            ...
            async function updateCards() {
                try {
                    ...
                    if (
                        data.max_temperature &&
                        data.temperature >= data.max_temperature
                    ) {
                        setNotif(
                            tempNotif,
                    ...
                    if (
                        data.max_humidity &&
                        data.humidity >= data.max_humidity
                    ) {
                        setNotif(
                            humiNotif,
                        ...
                        data.min_humidity &&
                        data.humidity <= data.min_humidity
                    ) {
                        setNotif(
                            humiNotif,
            ...
            function renderPagination(page, totalPages) {
                ...
                container.appendChild(
                    makeButton('⟩', page + 1, page === totalPages),
                )
                container.appendChild(
                    makeButton('⟫', totalPages, page === totalPages),
                )
            }
                ...
                .addEventListener('click', async function () {
                    ...
                    try {
                        ...
                        if (response.ok) {
                            ...
                            throw new Error(
                                data.error || 'Gagal mengirim permintaan',
                            )
                        }
                    } catch (error) {
